...
- Insert a new section at the top: `## v<X.Y.Z+1> — <YYYY-MM-DD>` with bullets grouped by area (Dashboard / Scanner / Project), one bullet per landed change with PR ref and author thanks.
